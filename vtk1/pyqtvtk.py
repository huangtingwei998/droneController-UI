...
filenames = ['C:/Users/huangtingwei/Desktop/飞行器pythonProject17/vtk1/resource/Drone-Tla.STL']
...
class VTKWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # self.actor[0].AddObserver("InteractionEvent", self.getdata)
        self.setCentralWidget(self.vll)
        self.resize(1100, 650)
        navigation_bar = QToolBar('Navigation')
        # self.setCentralWidget(self.renwin)
